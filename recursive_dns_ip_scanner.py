...
email_port = 465  # You can set it to 587 or 465 for SSL
use_ssl = True  # Should SSL be used (True/False)
...
# Check the send_email_while_empty variable
if send_email_while_empty or valid_ips:
    ...
    # Connect to the email server and send the email (with or without SSL)
    try:
        if use_ssl:
    ...
    print('Query results are empty, email not sent.')
